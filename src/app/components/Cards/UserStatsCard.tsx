      ...
      <CardContent>
        {!isLoggedIn ? (
          ...
          <div className="space-y-4 text-zinc-300">
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_RATING) && (
            ...
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_PROGRESS) && (
            ...
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_TOTAL_JUMPS) && (
            ...
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_FAVORITE_MAP) && (
              <div className="bg-zinc-900 p-2 rounded-lg">
            ...
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_RANK) && (
              <div className="bg-zinc-900 p-2 rounded-lg">
            ...
            {isFeatureEnabled(FeatureFlagKeys.ENABLE_USERSTATS_XP_LEVEL) && (
              <div className="bg-zinc-900 p-2 rounded-lg">
            ...
            {/* Add more sections here as needed, controlled by feature flags */}
          </div>
        ) : null}
