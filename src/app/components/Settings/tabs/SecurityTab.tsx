...
const SecurityTab: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_SECURITY_TWO_FACTOR_AUTH) && (
        <motion.div
      ...
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_SECURITY_TWO_ACTIVE_SESSIONS) && (
        <motion.div
          className="bg-[#1a1a1a] p-4 rounded space-y-4"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          <p className="text-gray-400">
            ...
            devices and change your password immediately. Your account may be compromised.
          </p>
      ...
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_SECURITY_LOGOUT_EVERYWHERE) && (
