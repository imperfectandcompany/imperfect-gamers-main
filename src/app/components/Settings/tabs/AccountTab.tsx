...
const AccountTab: React.FC = () => {
  ...
  return (
    <div className="space-y-4">
      {/* XP BONUS Section */}
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_BONUS_XP) && (
        <motion.div
      ...
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_LEVEL_DISPLAY) && (
        <motion.div
      ...
      {/* Level Cases Section */}
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_LEVEL_CASES) && (
        <motion.div
          className="bg-[#1a1a1a] p-4 rounded"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      {/* Redeem Referral Code Button */}
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_REDEEM_REFERRAL) && (
      ...
      {/* Free Rewards Stats Section */}
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_FREE_REWARDS_STATS) && (
        <motion.div
          className="bg-[#1a1a1a] p-4 rounded"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
      ...
      {/* Self-Lock Section */}
      {isFeatureEnabled(FeatureFlagKeys.ENABLE_SETTINGS_ACCOUNT_SELF_LOCK) && (
        <motion.div
          className="bg-[#1a1a1a] p-4 rounded"
          initial={{ opacity: 0, y: -20 }}
          animate={{ opacity: 1, y: 0 }}
